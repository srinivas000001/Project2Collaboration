...
public class TestFriend
{
	...
	{
		friend.setUserID("srinu");
		friend.setFriendID("mahesh");
		friend.setStatus('P');
		friend.setFriendFName("mahesh");
		friend.setUserFName("srinu");
...
//				System.out.println("Friend Name - "+list.get(i).getFriendID()+list.get(i).getUserID());
	...
	{
		boolean x = friendDAO.setUsersOnline("mahesh");
		if(x)
			System.out.println("Success...");
		else
	...
	{
		boolean x = friendDAO.setUsersOffline("mahesh");
		if(x)
			System.out.println("Success...");
		else
			System.out.println("Update Failed");
